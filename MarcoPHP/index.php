   ...
   <div class="container-fluid bg-dark p-0">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <h3 class="m-0 texto-éxito"> ADOPTA, NO COMPRES </h3>
            <?php
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='img/gato.jpg'>">
                ...
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-2 text-white animated slideInDown">Gatitos</h1>
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='img/perro2000x1000.jpg'>">
                ...
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-2 text-white animated slideInDown">Adopta un perrhijo</h1>
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='img/perro2000x1000.jpg'>">
                ...
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                         <div class="col-10 col-lg-8">
                                <h1 class="display-2 text-white animated slideInDown"> <3 </h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-3"> Perro feliz </p>
                                <a href="codigoS.php" class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">Ver mas</a>
                            </div>
                        </div>
                    </div>
